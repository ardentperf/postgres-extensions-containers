...
`pg_graphql` is built from the upstream pgrx release archive and packaged as a
CloudNativePG extension image for PostgreSQL 18 on bookworm and trixie.
...
The catalog/image source version is `1.6.2`.
