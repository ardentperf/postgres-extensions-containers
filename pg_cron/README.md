...
[pg_cron](https://github.com/citusdata/pg_cron) is a simple cron-based job scheduler for PostgreSQL
that runs inside the database as an extension, enabling you to schedule PostgreSQL commands directly
from the database.
